...
#[allow(dead_code)]
pub static CI_PLATFORM: Option<&str> = Some("Generic CI");
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/dennis_leedennis_lee/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/dennis_leedennis_lee/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/Users/dennis_leedennis_lee/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.92.0 (ded5c06cf 2025-12-08)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/Users/dennis_leedennis_lee/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/dennis_leedennis_lee/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
